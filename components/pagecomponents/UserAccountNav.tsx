  ...
  return (
    <DropdownMenu>
      <DropdownMenuTrigger className="outline-none border-none bg-transparent p-0">
        <div className="flex items-center gap-2 bg-secondary/50 px-3 py-1.5 rounded-full border border-border/50 hover:bg-secondary/80 transition-colors cursor-pointer">
