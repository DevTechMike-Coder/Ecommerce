      ...
      <div className="px-4 pb-4 space-y-4">
        <div className="space-y-1">
          ...
          <div className="flex items-start justify-between gap-4">
            ...
            <p className="font-black text-xl text-neutral-900">${price}</p>
          </div>
        </div>

        <Link href="/nextecommerce/cart">
          <button className="w-full flex items-center justify-between group/btn py-1 cursor-pointer">
