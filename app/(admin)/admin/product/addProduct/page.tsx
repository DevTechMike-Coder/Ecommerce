          ...
          <div className="space-y-8">
            <section className="bg-white p-8 rounded-[2rem] border shadow-sm space-y-6 sticky top-32">
              ...
              <div className="space-y-4">
                ...
                >
                  <SelectTrigger className="w-full h-14 bg-neutral-50 rounded-2xl border-2 border-transparent focus:border-primary/20 focus:bg-white transition-all outline-none font-medium text-left px-4">
              ...
              <div className="space-y-4">
                ...
                <Select
                  ...
                  onValueChange={(value) => setProductData({ ...productData, collectionTag: value })}
                >
                  <SelectTrigger className="w-full h-14 bg-neutral-50 rounded-2xl border-2 border-transparent focus:border-primary/20 focus:bg-white transition-all outline-none font-medium text-left px-4">
                    <SelectValue placeholder="Select Collection Tag" />
                  </SelectTrigger>
                  <SelectContent className="rounded-2xl border-2">
                    <SelectItem value="REGULAR" className="rounded-xl py-3 cursor-pointer">Regular</SelectItem>
                    <SelectItem value="LATEST" className="rounded-xl py-3 cursor-pointer">Latest Collection</SelectItem>
                    <SelectItem value="BESTSELLER" className="rounded-xl py-3 cursor-pointer">Bestseller</SelectItem>
                  </SelectContent>
                </Select>
              </div>
